 ...
 *
 * A {@link module:ol/style/raster~RasterStyle style} can be applied to sources that provide
 * array data, such as {@link module:ol/source/DataTile~DataTileSource} and
 * {@link module:ol/source/GeoTIFF~GeoTIFFSource}.  A style that reads bands at an offset
...
class TileLayer extends BaseTileLayer {
  ...
  constructor(options) {
    ...
    /**
     * Bumped whenever the style or its variables change, so that tiles rendered with the
     * previous style are not reused.
     * @type {number}
     * @private
     */
