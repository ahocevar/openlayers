...
/**
 * Re-exported for backwards compatibility.  The processor now lives in
 * {@link module:ol/Processor~Processor}, where it is also used to run raster
 * styles for data tiles.
 */
export {Processor};
