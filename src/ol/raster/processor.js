 ...
 *
 * Set `0` to apply styles on the main thread instead.  Not recommended, but required to make
 * raster styles work under a content security policy that does not allow `worker-src blob:`.
 *
...
/**
 * Take a hold on the pool that applies raster styles.  Every hold must be given back with
 * {@link releaseProcessor}.
